...
import com.mafgwo.prototype.model.ProjectDataWrapper;
...
public class JsonFileProjectRepositoryImpl implements ProjectRepository {
    ...
    @Resource
    private PrototypeProperties configuration;
    ...
    private File getProjectMetaJsonFile() {
        ...
        String path = workDir + File.separator + PrototypeProperties.PROJECT_META_FILE_NAME;
